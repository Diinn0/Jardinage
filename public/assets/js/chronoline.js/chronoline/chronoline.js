...
function Chronoline(domElement, events, options) {
    ...
    var defaults = {
        defaultStartDate: new Date(2021, 0, 1),  // the date furthest to the left on load. Defaults to today
        startDate: new Date(2021, 0, 1),  // start of the timeline. Defaults to first event date
        endDate: new Date(2021, 11, 31),  // end of the timeline. Defauls to the last event date

        visibleSpan: DAY_IN_MILLISECONDS * 365,  // in milliseconds,
        ...
        hashLength: 1,  // length of the hash marks for the days
        minEventsHeight: 40,
        ...
        subSubLabel: null,  // TODO generalize this code
        subSubLabelMargin: 2,
